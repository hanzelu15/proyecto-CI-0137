      ...
      <div className="h-full flex flex-col justify-items-center items-center  mt-20">
        ...
        <form action="" className="w-[350px]">
          ...
          <div className="flex justify-between  items-center">
            ...
            <button
              type="button"
              class="text-white bg-orange-50 hover:bg-orange-100 focus:ring-4 focus:ring-blue-300 font-medium text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            >
              Registrar
            </button>
          </div>
