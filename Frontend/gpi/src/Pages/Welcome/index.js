...
export const Welcome = () => {
  return (
    <div
      className="w-full flex flex-col md:flex-row  items-center bg-no-repeat bg-cover h-screen"
    ...
    >
      ...
      <div className=" w-1/2 h-full flex flex-col justify-center items-center gap-12 md:gap-36">
        <Link
          className="py-4 px-8 text-white bg-orange-50 rounded-lg hover:bg-orange-100 focus:ring-4 focus:ring-blue-300 font-light text-3xl text-center   focus:outline-none "
          to="login"
        >
          Iniciar Sesión
        </Link>
        <Link
          className="text-white py-4 px-8 bg-orange-50 rounded-lg hover:bg-orange-100 focus:ring-4 focus:ring-blue-300 font-light text-3xl text-center   focus:outline-none "
          to="register"
        >
          Registrarse
        </Link>
